 ...
 * Hybrid results returns
 */
class TransformedHybridPaginatorAdapter extends RawPaginatorAdapter
{
    private $transformer;
    ...
    {
        return new TransformedHybridPartialResults($this->getElasticaResults($offset, $length), $this->transformer);
    }
}
